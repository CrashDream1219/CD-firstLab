 ...
 * @since 2020-12-04
 */
public class RemoteController_two extends DependentLayout
     ...
     */
    public RemoteController_two(Context context) {
        super(context);
    ...
    public void initView() {
        ...
        componentParent = LayoutScatter.getInstance(context).parse(
                ResourceTable.Layout_remote_controller_two,
                this,
                false);
     ...
     */
    public void setRemoteControllerCallback2(RemoteControllerListener listener) {
